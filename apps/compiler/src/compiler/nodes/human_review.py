...
from compiler.human_review_flow import create_human_review_record
...
def human_review_node(state: GraphState) -> dict:
    ...
    _, human_review_uri = create_human_review_record(state, staging_uri)
    storage.write_audit_event(
        AuditEvent(
            ...
            payload={
                ...
                "human_review_uri": human_review_uri,
            },
        )
    )
